...
COLOR_DISCONNECTED='#747c84'       # Device Disconnected
COLOR_NEWDEVICE='#dfe1e8'          # New Device
COLOR_BATTERY_90='#a3be8c'         # Battery >= 90
COLOR_BATTERY_80='#a3be8c'         # Battery >= 80
COLOR_BATTERY_70='#a3be8c'         # Battery >= 70
COLOR_BATTERY_60='#ebcb8b'         # Battery >= 60
COLOR_BATTERY_50='#ebcb8b'         # Battery >= 50
...
get_icon () {
    ...
    case $1 in
    "-1")     ICON="%{o$COLOR_DISCONNECTED}$icon%{o-}" ;;
    "-2")     ICON="%{o$COLOR_NEWDEVICE}$icon%{o-}" ;;
    5*)     ICON="%{o$COLOR_BATTERY_50}$icon%{o-}" ;;
    6*)     ICON="%{o$COLOR_BATTERY_60}$icon%{o-}" ;;
    7*)     ICON="%{o$COLOR_BATTERY_70}$icon%{o-}" ;;
    8*)     ICON="%{o$COLOR_BATTERY_80}$icon%{o-}" ;;
    9*|100) ICON="%{o$COLOR_BATTERY_90}$icon%{o-}" ;;
    *)      ICON="%{o$COLOR_BATTERY_LOW}$icon%{o-}" ;;
    esac
    echo $ICON
}
