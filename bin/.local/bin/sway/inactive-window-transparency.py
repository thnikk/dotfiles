...
# Ignore these programs and leave them at 100%
WINDOW_IGNORE = {
    'firefox',
...
def on_window_focus(inactive_opacity, ipc, event):
    ...
    if focused.id != prev_focused.id:  # https://github.com/swaywm/sway/issues/2859
        ...
        prev_name = get_class(prev_focused)
        if workspace == prev_workspace and prev_name not in WINDOW_IGNORE:
